<!--{fin}-->
	...
	<form id="listas" name="listados" method="post" action="./index.php?ac=af_impresiones" target='_self'>
		...
		<select id="filtro" name='filtro'>
			...
			<option value="1" >Afiliados por Padron (todos)</option>			
		</select>
		...
		<div class="col_3 bloques" id="textotitulo">
			<fieldset class="tooltip-bottom" title="Titulo para asignar al remito.">
				...
				<input type="text" id="titulo" name="titulo"/> <label for="check1" class="inline">Titulo</label>
			</fieldset>
		</div>
	...
	<tr>
	<td>
		{nro} | <a href='#' class='{nro}' id='{id_afiliado}'>{id_afiliado}</a>
	</td>	
